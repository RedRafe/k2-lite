...
-- -- GRAPHICS PATHS
-----------------------------------------------------------------------------------------------------------------
kr_graphic_mod_path = "__Krastorio2Assets__/"
-----------------------------------------------------------------------------------------------------------------
-- Icons paths
kr_achievements_icons_path = kr_graphic_mod_path .. "achievements/"
kr_backgrounds_icons_path = kr_graphic_mod_path .. "backgrounds/"
kr_icons_path = kr_graphic_mod_path .. "icons/"
kr_particles_path = kr_graphic_mod_path .. "particles/"
...
kr_crash_site_icons_path = kr_entities_icons_path .. "crash-site/"
kr_recipes_icons_path = kr_icons_path .. "recipes/"
kr_resources_icons_path = kr_icons_path .. "resources/"
kr_items_icons_path = kr_icons_path .. "items/"
kr_capsules_icons_path = kr_icons_path .. "capsules/"
kr_items_with_variations_icons_path = kr_icons_path .. "items-with-variations/"
...
kr_equipments_tiers_icon_path = kr_equipments_icon_path .. "tiers/"
...
kr_crash_site_sprites_path = kr_entities_sprites_path .. "crash-site/"
...
-----------------------------------------------------------------------------------------------------------------
-- Tiles
kr_tiles_path = kr_graphic_mod_path .. "tiles/"
-----------------------------------------------------------------------------------------------------------------
-- -- SOUNDS PATHS
-----------------------------------------------------------------------------------------------------------------
kr_sounds_mod = "__Krastorio2Assets__/sounds/"
-----------------------------------------------------------------------------------------------------------------
...
kr_others_sounds_path = kr_sounds_mod .. "others/"
-----------------------------------------------------------------------------------------------------------------
-- -- COMPATIBILITY SCRIPTS PATHS
-----------------------------------------------------------------------------------------------------------------
kr_data_compatibility_path = kr_path .. "compatibility-scripts/data/"
kr_data_updates_compatibility_path = kr_path .. "compatibility-scripts/data-updates/"
kr_data_final_fixes_compatibility_path = kr_path .. "compatibility-scripts/data-final-fixes/"
kr_settings_compatibility_path = kr_path .. "compatibility-scripts/settings/"
kr_settings_updates_compatibility_path = kr_path .. "compatibility-scripts/settings-updates/"
-----------------------------------------------------------------------------------------------------------------
