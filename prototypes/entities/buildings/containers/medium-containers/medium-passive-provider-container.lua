...
local _specific = "medium-passive-provider-container/"
...
data:extend({
  {
    ...
    animation = {
      filename = _sprites_path .. "medium-passive-provider-container.png",
      priority = "extra-high",
      width = 85,
      height = 85,
      frame_count = 6,
      hr_version = {
        filename = _sprites_path .. "hr-medium-passive-provider-container.png",
        priority = "extra-high",
        width = 340,
        height = 340,
        frame_count = 6,
